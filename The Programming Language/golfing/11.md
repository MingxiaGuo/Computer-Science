...
* 这门语言是什么，为什么要创造这门语言，以及这门语言要解决什么问 题。
* 并发
...
* $ touch .bash\_profile  /  vim .bash\_profile

* $ export PATH=$PATH:/usr/local/go/bin

* $ export GOPATH=/Users/guogmx/Documents/workspace/workspace\_go
...
* $ cd /Users/guogmx/Documents/workspace/workspace\_go
...
9. $ go test  运行测试文件（以\_test.go结尾的文件）
